...
import com.dreamgear.http.handler.domain.JsonUtil;
...
//			}
			System.out.println("HttpServerHandler:logicName : " + logicName);
			if("".equals(logicName)){
...
//			if (!(e instanceof ClassNotFoundException)){
			System.out.println("HttpServerHandler:http handler error"+e);
//			}
		}
